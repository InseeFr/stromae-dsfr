...
- The server now send a _409 conflict_ error when data is sent but the questionnaire was already validated (so it cannot be updated anymore). A custom error message is displayed to explain this to the user and they will be redirected to portal page.

## [2.9.0](https://github.com/InseeFr/stromae-dsfr/releases/tag/2.9.0) - 2026-06-15
...
- The dropdown options (with html encoding) are displayed correctly now.
- Cleaning variables from options based on a variable. Fixed by Lunatic 3.13.1 and 3.13.3
...
- Upgrade Lunatic from 3.10.0 to [3.11.0](https://github.com/InseeFr/Lunatic/blob/3.0/CHANGELOG.md#3110---2026-02-02)

## [2.4.0](https://github.com/InseeFr/stromae-dsfr/releases/tag/2.4.0) - 2026-01-30

### Changed

- Upgrade React to v19
- Upgrade Lunatic from 3.7.6 to [3.10.0](https://github.com/InseeFr/Lunatic/blob/3.0/CHANGELOG.md#3100---2026-01-27)
