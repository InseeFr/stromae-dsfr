...
import type {
  CleanDataParams,
  GenerateDepositProofParams,
  GetInterrogationsByStateDataParams,
...
/**
 * Authorized roles: ADMIN / WEBCLIENT /
 * @summary Synchronize an interrogation
 */
export const synchronizeInterrogation = (
  id: string,
  options?: SecondParameter<typeof stromaeInstance>,
  signal?: AbortSignal,
) => {
  return stromaeInstance<void>(
    { url: `/api/interrogations/${id}/synchronize`, method: 'POST', signal },
    options,
  )
}

export const getSynchronizeInterrogationMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof synchronizeInterrogation>>,
    TError,
    { id: string },
    TContext
  >
  ...
  TContext
> => {
  const mutationKey = ['synchronizeInterrogation']
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      'mutationKey' in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return synchronizeInterrogation(id, requestOptions)
  }

  return { mutationFn, ...mutationOptions }
}

export type SynchronizeInterrogationMutationResult = NonNullable<
  Awaited<ReturnType<typeof synchronizeInterrogation>>
>

export type SynchronizeInterrogationMutationError = unknown

/**
 * @summary Synchronize an interrogation
 */
export const useSynchronizeInterrogation = <
  TError = unknown,
  TContext = unknown,
>(
  options?: {
  ...
  TContext
> => {
  const mutationOptions = getSynchronizeInterrogationMutationOptions(options)

  return useMutation(mutationOptions, queryClient)
}
/**
 * Authorized roles: ADMIN / WEBCLIENT /
 * @summary Retrieve interrogations filtered by state data
 */
export const getInterrogationsByStateData = (
  params?: GetInterrogationsByStateDataParams,
  options?: SecondParameter<typeof stromaeInstance>,
  signal?: AbortSignal,
) => {
  return stromaeInstance<Interrogation[]>(
    { url: `/api/interrogations/state-data`, method: 'GET', params, signal },
    options,
  )
}

export const getGetInterrogationsByStateDataQueryKey = (
  params?: GetInterrogationsByStateDataParams,
) => {
  return [
    `/api/interrogations/state-data`,
    ...(params ? [params] : []),
  ] as const
}

export const getGetInterrogationsByStateDataQueryOptions = <
  TData = Awaited<ReturnType<typeof getInterrogationsByStateData>>,
  TError = unknown,
>(
  params?: GetInterrogationsByStateDataParams,
  options?: {
    query?: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof getInterrogationsByStateData>>,
        TError,
        TData
      >
    >
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetInterrogationsByStateDataQueryKey(params)

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getInterrogationsByStateData>>
  > = ({ signal }) =>
    getInterrogationsByStateData(params, requestOptions, signal)
...
export type GetInterrogationsByStateDataQueryResult = NonNullable<
  Awaited<ReturnType<typeof getInterrogationsByStateData>>
>
export type GetInterrogationsByStateDataQueryError = unknown

export function useGetInterrogationsByStateData<
  TData = Awaited<ReturnType<typeof getInterrogationsByStateData>>,
  TError = unknown,
>(
  params: undefined | GetInterrogationsByStateDataParams,
  options: {
    query: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof getInterrogationsByStateData>>,
...
>(
  ...
  const queryOptions = getGetInterrogationsByStateDataQueryOptions(
    params,
    options,
  )
...
export const generateDepositProof = (
  id: string,
  params?: GenerateDepositProofParams,
...
export const getGenerateDepositProofQueryKey = (
  id?: string,
  params?: GenerateDepositProofParams,
) => {
  return [
    `/api/interrogations/${id}/deposit-proof`,
    ...(params ? [params] : []),
  ] as const
}
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGenerateDepositProofQueryKey(id, params)

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof generateDepositProof>>
  > = ({ signal }) => generateDepositProof(id, params, requestOptions, signal)
...
>(
  id: string,
  params: undefined | GenerateDepositProofParams,
  options: {
    query: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof generateDepositProof>>,
...
>(
  ...
  const queryOptions = getGenerateDepositProofQueryOptions(id, params, options)
