...
/**
 * Authorized roles: ADMIN / WEBCLIENT / REVIEWER / REVIEWER_ALTERNATIVE / INTERVIEWER / SURVEY_UNIT /
 * @summary Get comment for an interrogation
 */
export const getCommentByInterrogation = (
  id: string,
  options?: SecondParameter<typeof stromaeInstance>,
  signal?: AbortSignal,
) => {
  return stromaeInstance<GetCommentByInterrogation200>(
    { url: `/api/interrogations/${id}/comment`, method: 'GET', signal },
    options,
  )
}

export const getGetCommentByInterrogationQueryKey = (id: string) => {
  return [`/api/interrogations/${id}/comment`] as const
}

export const getGetCommentByInterrogationQueryOptions = <
  TData = Awaited<ReturnType<typeof getCommentByInterrogation>>,
  TError = unknown,
>(
  id: string,
  options?: {
    query?: Partial<
      UseQueryOptions<
        Awaited<ReturnType<typeof getCommentByInterrogation>>,
        TError,
        TData
      >
    >
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetCommentByInterrogationQueryKey(id)

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getCommentByInterrogation>>
  > = ({ signal }) => getCommentByInterrogation(id, requestOptions, signal)
...
export type GetCommentByInterrogationQueryResult = NonNullable<
  Awaited<ReturnType<typeof getCommentByInterrogation>>
>
export type GetCommentByInterrogationQueryError = unknown

export function useGetCommentByInterrogation<
  TData = Awaited<ReturnType<typeof getCommentByInterrogation>>,
  TError = unknown,
>(
  id: string,
...
>(
  ...
  const queryOptions = getGetCommentByInterrogationQueryOptions(id, options)
...
/**
 * Authorized roles: ADMIN / WEBCLIENT / REVIEWER / REVIEWER_ALTERNATIVE / INTERVIEWER / SURVEY_UNIT /
 * @summary Update comment for an interrogation
 */
export const setComment = (
  ...
  return stromaeInstance<void>(
    {
      url: `/api/interrogations/${id}/comment`,
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
      data: setCommentBody,
    },
 ...
 * @summary Update comment for an interrogation
 */
export const useSetComment = <TError = unknown, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof setComment>>,
      TError,
