              ...
              <div className={fr.cx('fr-table__container')}>
                <div className={fr.cx('fr-table__content')}>
                  <table className={fr.cx('fr-cell--multiline')}>
                    ...
                    <thead>
                      <tr>
                        <th scope="col">{t('collectPage.VtlDevTools.tableHeaderExpression')}</th>
                        <th scope="col">{t('collectPage.VtlDevTools.tableHeaderBindings')}</th>
                        <th scope="col">{t('collectPage.VtlDevTools.tableHeaderMessage')}</th>
                        <th scope="col">{t('collectPage.VtlDevTools.tableHeaderPage')}</th>
                      </tr>
                    </thead>
                    <tbody>
                      {errors?.map((e) => (
