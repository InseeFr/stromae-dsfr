...
export const source: LunaticSource = {
  ...
  generatingDate: '29-04-2024 11:50:02',
  pagination: 'sequence',
  maxPage: '7',
  label: {
    value: 'QNONREG - Questionnaire tous composants sans boucle',
    type: 'VTL|MD',
  },
  components: [
    {
    ...
    },
    {
      ...
      label: {
        value:
          '"➡ 2. " || "Je suis le libellé de la question de type texte de longueur supérieure à 250 caractères. et C\'est un libellé qui est aussi très long car sait-on jamais..."',
        type: 'VTL|MD',
      },
      declarations: [
        {
    ...
    },
    {
      ...
      label: {
        value:
          '"➡ 3. " || "Numérique entier sans unité - grand (max= 999999999)"',
        type: 'VTL|MD',
      },
      declarations: [
        {
      ...
      components: [
        {
          ...
          controls: [
            ...
            },
            {
              ...
              control: {
                value:
                  'not(not(isnull(INTEGER))  and round(INTEGER,0)<>INTEGER)',
                type: 'VTL',
              },
              errorMessage: {
                value:
          ...
          controls: [
            {
              ...
              control: {
                value:
                  'not(not(isnull(FLOAT)) and (0.00>FLOAT or 1000.00<FLOAT))',
                type: 'VTL',
              },
              errorMessage: {
    ...
    },
    {
      ...
      componentType: 'Question',
      page: '1',
      label: { value: '"➡ 6. " || "Date jour"', type: 'VTL|MD' },
      components: [
        {
          id: 'jfjfckyw',
          ...
          controls: [
            {
              ...
              errorMessage: {
                value:
                  '"La date saisie doit être comprise entre 2000-01 et 2020-03."',
                type: 'VTL|MD',
              },
            },
          ],
          ...
          controls: [
            {
              ...
              errorMessage: {
                value:
                  '"La date saisie doit être comprise entre 2000 et 2020."',
                type: 'VTL|MD',
              },
            },
          ],
    ...
    },
    {
      ...
      page: '1',
      label: {
        value: '"➡ 10. " || "Booléen (bientôt révolu"',
        type: 'VTL|MD',
      },
      components: [
        {
    ...
    },
    {
      ...
      label: {
        value:
          '"➡ 1. " || "Question à choix unique / présentation bouton radio"',
        type: 'VTL|MD',
      },
      components: [
        {
          ...
          options: [
            ...
            },
            {
              ...
              label: {
                value:
                  '"code2 le libellé du code 2 contient *de l\'italique* "',
                type: 'VTL|MD',
              },
            },
            {
    ...
    },
    {
      ...
      label: {
        value:
          '"➡ 2. " || "Question à choix unique - présentation case à cocher décochable"',
        type: 'VTL|MD',
      },
      components: [
        {
    ...
    },
    {
      ...
      label: {
        value:
          '"➡ 3. " || "Question à choix unique - présentation images - non fonctionnel Lunatic (Symboles en attendant) - besoin Conjoncture"',
        type: 'VTL|MD',
      },
      components: [
        {
          ...
          options: [
            {
              value: '1',
              label: { value: '"soleil"', type: 'VTL|MD' },
            },
            {
              value: '2',
    ...
    },
    {
      ...
      label: {
        value:
          '"➡ 4. " || "Question à choix unique - présentation liste déroulante"',
        type: 'VTL|MD',
      },
      components: [
        {
          ...
          options: [
            {
              value: '01',
              label: { value: '"Ain"', type: 'VTL|MD' },
            },
            {
              value: '02',
              label: { value: '"Aisne"', type: 'VTL|MD' },
            },
            {
              value: '03',
              label: { value: '"Allier"', type: 'VTL|MD' },
            },
            {
              value: '04',
              label: {
            ...
            {
              value: '05',
              label: { value: '"Hautes-Alpes"', type: 'VTL|MD' },
            },
            {
              value: '06',
              label: { value: '"Alpes-Maritimes"', type: 'VTL|MD' },
            },
            {
              value: '07',
              label: { value: '"Ardèche"', type: 'VTL|MD' },
            },
            {
              value: '08',
              label: { value: '"Ardennes"', type: 'VTL|MD' },
            },
            {
              value: '09',
              label: { value: '"Ariège"', type: 'VTL|MD' },
            },
            {
              value: '10',
              label: { value: '"Aube"', type: 'VTL|MD' },
            },
            {
              value: '11',
              label: { value: '"Aude"', type: 'VTL|MD' },
            },
            {
              value: '12',
              label: { value: '"Aveyron"', type: 'VTL|MD' },
            },
            {
              value: '13',
              label: { value: '"Bouches-du-Rhône"', type: 'VTL|MD' },
            },
            {
              value: '14',
              label: { value: '"Calvados"', type: 'VTL|MD' },
            },
            {
              value: '15',
              label: { value: '"Cantal"', type: 'VTL|MD' },
            },
            {
              value: '16',
              label: { value: '"Charente"', type: 'VTL|MD' },
            },
            {
              value: '17',
              label: { value: '"Charente-Maritime"', type: 'VTL|MD' },
            },
            {
              value: '18',
              label: { value: '"Cher"', type: 'VTL|MD' },
            },
            {
              value: '19',
              label: { value: '"Corrèze"', type: 'VTL|MD' },
            },
            {
              value: '2A',
              label: { value: '"Corse-du-Sud"', type: 'VTL|MD' },
            },
            {
              value: '2B',
              label: { value: '"Haute-Corse"', type: 'VTL|MD' },
            },
            {
              value: '21',
              label: { value: '"Côte-d\'Or"', type: 'VTL|MD' },
            },
            {
              value: '22',
              label: { value: '"Côtes d\'Armor"', type: 'VTL|MD' },
            },
            {
              value: '23',
              label: { value: '"Creuse"', type: 'VTL|MD' },
            },
            {
              value: '24',
              label: { value: '"Dordogne"', type: 'VTL|MD' },
            },
            {
              value: '25',
              label: { value: '"Doubs"', type: 'VTL|MD' },
            },
            {
              value: '26',
              label: { value: '"Drôme"', type: 'VTL|MD' },
            },
            {
              value: '27',
              label: { value: '"Eure"', type: 'VTL|MD' },
            },
            {
              value: '28',
              label: { value: '"Eure-et-Loir"', type: 'VTL|MD' },
            },
            {
              value: '29',
              label: { value: '"Finistère"', type: 'VTL|MD' },
            },
            {
              value: '30',
              label: { value: '"Gard"', type: 'VTL|MD' },
            },
            {
              value: '31',
              label: { value: '"Haute-Garonne"', type: 'VTL|MD' },
            },
            {
              value: '32',
              label: { value: '"Gers"', type: 'VTL|MD' },
            },
            {
              value: '33',
              label: { value: '"Gironde"', type: 'VTL|MD' },
            },
            {
              value: '34',
              label: { value: '"Hérault"', type: 'VTL|MD' },
            },
            {
              value: '35',
              label: { value: '"Ille-et-Vilaine"', type: 'VTL|MD' },
            },
            {
              value: '36',
              label: { value: '"Indre"', type: 'VTL|MD' },
            },
            {
              value: '37',
              label: { value: '"Indre-et-Loire"', type: 'VTL|MD' },
            },
            {
              value: '38',
              label: { value: '"Isère"', type: 'VTL|MD' },
            },
            {
              value: '39',
              label: { value: '"Jura"', type: 'VTL|MD' },
            },
            {
              value: '40',
              label: { value: '"Landes"', type: 'VTL|MD' },
            },
            {
              value: '41',
              label: { value: '"Loir-et-Cher"', type: 'VTL|MD' },
            },
            {
              value: '42',
              label: { value: '"Loire"', type: 'VTL|MD' },
            },
            {
              value: '43',
              label: { value: '"Haute-Loire"', type: 'VTL|MD' },
            },
            {
              value: '44',
              label: { value: '"Loire-Atlantique"', type: 'VTL|MD' },
            },
            {
              value: '45',
              label: { value: '"Loiret"', type: 'VTL|MD' },
            },
            {
              value: '46',
              label: { value: '"Lot"', type: 'VTL|MD' },
            },
            {
              value: '47',
              label: { value: '"Lot-et-Garonne"', type: 'VTL|MD' },
            },
            {
              value: '48',
              label: { value: '"Lozère"', type: 'VTL|MD' },
            },
            {
              value: '49',
              label: { value: '"Maine-et-Loire"', type: 'VTL|MD' },
            },
            {
              value: '50',
              label: { value: '"Manche"', type: 'VTL|MD' },
            },
            {
              value: '51',
              label: { value: '"Marne"', type: 'VTL|MD' },
            },
            {
              value: '52',
              label: { value: '"Haute-Marne"', type: 'VTL|MD' },
            },
            {
              value: '53',
              label: { value: '"Mayenne"', type: 'VTL|MD' },
            },
            {
              value: '54',
            ...
            {
              value: '55',
              label: { value: '"Meuse"', type: 'VTL|MD' },
            },
            {
              value: '56',
              label: { value: '"Morbihan"', type: 'VTL|MD' },
            },
            {
              value: '57',
              label: { value: '"Moselle"', type: 'VTL|MD' },
            },
            {
              value: '58',
              label: { value: '"Nièvre"', type: 'VTL|MD' },
            },
            {
              value: '59',
              label: { value: '"Nord"', type: 'VTL|MD' },
            },
            {
              value: '60',
              label: { value: '"Oise"', type: 'VTL|MD' },
            },
            {
              value: '61',
              label: { value: '"Orne"', type: 'VTL|MD' },
            },
            {
              value: '62',
              label: { value: '"Pas-de-Calais"', type: 'VTL|MD' },
            },
            {
              value: '63',
              label: { value: '"Puy-de-Dôme"', type: 'VTL|MD' },
            },
            {
              value: '64',
            ...
            {
              value: '65',
              label: { value: '"Hautes-Pyrénées"', type: 'VTL|MD' },
            },
            {
              value: '66',
            ...
            {
              value: '67',
              label: { value: '"Bas-Rhin"', type: 'VTL|MD' },
            },
            {
              value: '68',
              label: { value: '"Haut-Rhin"', type: 'VTL|MD' },
            },
            {
              value: '69',
              label: { value: '"Rhône"', type: 'VTL|MD' },
            },
            {
              value: '70',
              label: { value: '"Haute-Saône"', type: 'VTL|MD' },
            },
            {
              value: '71',
              label: { value: '"Saône-et-Loire"', type: 'VTL|MD' },
            },
            {
              value: '72',
              label: { value: '"Sarthe"', type: 'VTL|MD' },
            },
            {
              value: '73',
              label: { value: '"Savoie"', type: 'VTL|MD' },
            },
            {
              value: '74',
              label: { value: '"Haute-Savoie"', type: 'VTL|MD' },
            },
            {
              value: '75',
            ...
            {
              value: '76',
              label: { value: '"Seine-Maritime"', type: 'VTL|MD' },
            },
            {
              value: '77',
              label: { value: '"Seine-et-Marne"', type: 'VTL|MD' },
            },
            {
              value: '78',
              label: { value: '"Yvelines"', type: 'VTL|MD' },
            },
            {
              value: '79',
              label: { value: '"Deux-Sèvres"', type: 'VTL|MD' },
            },
            {
              value: '80',
              label: { value: '"Somme"', type: 'VTL|MD' },
            },
            {
              value: '81',
              label: { value: '"Tarn"', type: 'VTL|MD' },
            },
            {
              value: '82',
              label: { value: '"Tarn-et-Garonne"', type: 'VTL|MD' },
            },
            {
              value: '83',
              label: { value: '"Var"', type: 'VTL|MD' },
            },
            {
              value: '84',
              label: { value: '"Vaucluse"', type: 'VTL|MD' },
            },
            {
              value: '85',
              label: { value: '"Vandée"', type: 'VTL|MD' },
            },
            {
              value: '86',
              label: { value: '"Vienne"', type: 'VTL|MD' },
            },
            {
              value: '87',
              label: { value: '"Haute-Vienne"', type: 'VTL|MD' },
            },
            {
              value: '88',
              label: { value: '"Vosges"', type: 'VTL|MD' },
            },
            {
              value: '89',
              label: { value: '"Yonne"', type: 'VTL|MD' },
            },
            {
              value: '90',
              label: {
            ...
            {
              value: '91',
              label: { value: '"Essonne"', type: 'VTL|MD' },
            },
            {
              value: '92',
              label: { value: '"Hauts-de-Seine"', type: 'VTL|MD' },
            },
            {
              value: '93',
              label: { value: '"Seine-St-Denis"', type: 'VTL|MD' },
            },
            {
              value: '94',
              label: { value: '"Val-de-Marne"', type: 'VTL|MD' },
            },
            {
              value: '95',
              label: { value: '"Val-D\'Oise"', type: 'VTL|MD' },
            },
            {
              value: '971',
              label: { value: '"Guadeloupe"', type: 'VTL|MD' },
            },
            {
              value: '972',
              label: { value: '"Martinique"', type: 'VTL|MD' },
            },
            {
              value: '973',
              label: { value: '"Guyane"', type: 'VTL|MD' },
            },
            {
              value: '974',
              label: { value: '"La Réunion"', type: 'VTL|MD' },
            },
            {
              value: '976',
              label: { value: '"Mayotte"', type: 'VTL|MD' },
            },
          ],
    ...
    },
    {
      ...
      componentType: 'Question',
      page: '2',
      label: { value: '"➡ 5. " || "Suggester pays"', type: 'VTL|MD' },
      components: [
        {
          id: 'ljobiblh',
    ...
    },
    {
      ...
      componentType: 'Question',
      page: '2',
      label: { value: '"➡ 6. " || "Suggester PCS"', type: 'VTL|MD' },
      components: [
        {
          id: 'k6ccoydl',
          componentType: 'Suggester',
    ...
    },
    {
      ...
      label: {
        value:
          '"➡ 7. " || "Question à choix multiple - réponse booléen basique"',
        type: 'VTL|MD',
      },
      components: [
        {
    ...
    },
    {
      ...
      label: {
        value:
          '"➡ 8. " || "Question à choix multiple - réponse oui/non case à cocher"',
        type: 'VTL|MD',
      },
      components: [
        {
      ...
      declarations: [
        {
          ...
          position: 'AFTER_QUESTION_TEXT',
          label: {
            value: '"Ce module concerne les tableaux "',
            type: 'VTL|MD',
          },
        },
      ],
      ...
      declarations: [
        {
          ...
          label: {
            value:
              '"Rappel de la valeur collectée INTEGER = " || cast(INTEGER,string) ',
            type: 'VTL|MD',
          },
        },
      ],
      components: [
        {
          ...
          body: [
            [
              {
                value: '1',
                label: { value: '"moins de 15"', type: 'VTL|MD' },
              },
              {
                componentType: 'InputNumber',
                min: 0.0,
            ...
            [
              {
                value: '2',
                label: { value: '"de 16 à 17 ans"', type: 'VTL|MD' },
              },
              {
                componentType: 'InputNumber',
                min: 0.0,
            ...
            [
              {
                value: '3',
                label: { value: '"de 18 à 19 ans"', type: 'VTL|MD' },
              },
              {
                componentType: 'InputNumber',
                min: 0.0,
            ...
            [
              {
                value: '4',
                label: { value: '"20 et plus"', type: 'VTL|MD' },
              },
              {
                componentType: 'InputNumber',
                min: 0.0,
    ...
    },
    {
      ...
      page: '3',
      label: {
        value: '"➡ 2. " || "Tableau un axe simple, une mesure, sans unité"',
        type: 'VTL|MD',
      },
      declarations: [
        {
          ...
          position: 'AFTER_QUESTION_TEXT',
          label: {
            value: '"COntrole sur somme des lignes > 100"',
            type: 'VTL|MD',
          },
        },
      ],
    ...
    },
    {
      ...
      label: {
        value:
          '"➡ 3. " || "Tableau un axe simple, plusieurs mesures, sans unité"',
        type: 'VTL|MD',
      },
      components: [
        {
          ...
          header: [
            ...
            {
              label: {
                value: '"Mesure de type numérique"',
                type: 'VTL|MD',
              },
            },
            {
    ...
    },
    {
      ...
      label: {
        value:
          '"➡ 4. " || "Tableau 2 axes - 1 mesure de type numérique, sans unité"',
        type: 'VTL|MD',
      },
      components: [
        {
    ...
    },
    {
      ...
      label: {
        value:
          '"➡ 5. " || "Tableau 1 axe avec hiérarchie , 1 mesure, avec unité (cas d\'école...)"',
        type: 'VTL|MD',
      },
      components: [
        {
          ...
          body: [
            [
              ...
              {
                value: '11',
                label: { value: '"code 1 1"', type: 'VTL|MD' },
              },
              {
                componentType: 'InputNumber',
                min: 0.0,
            ...
            [
              {
                value: '12',
                label: { value: '"code 1 2"', type: 'VTL|MD' },
              },
              {
                componentType: 'InputNumber',
                min: 0.0,
            ...
            [
              ...
              {
                value: '21',
                label: { value: '"code 2 1"', type: 'VTL|MD' },
              },
              {
                componentType: 'InputNumber',
                min: 0.0,
            ...
            [
              {
                value: '22',
                label: { value: '"code 2 2"', type: 'VTL|MD' },
              },
              {
                componentType: 'InputNumber',
                min: 0.0,
            ...
            [
              {
                value: '23',
                label: { value: '"code 2 3"', type: 'VTL|MD' },
              },
              {
                componentType: 'InputNumber',
                min: 0.0,
    ...
    },
    {
      ...
      label: {
        value:
          '"➡ 6. " || "Tableau dynamique jusque 5 lignes, 2 mesures dont une unité "',
        type: 'VTL|MD',
      },
      declarations: [
        {
          ...
          label: {
            value:
              '"La question suivante est une question de type tableau dynamique."',
            type: 'VTL|MD',
          },
        },
      ],
          ...
          controls: [
            {
              ...
              errorMessage: {
                value:
                  '" La valeur doit être comprise entre 0.00 et 10000.00."',
                type: 'VTL|MD',
              },
            },
            {
    ...
    },
    {
      ...
      hierarchy: {
        sequence: {
          ...
          label: {
            value:
              '"IV - " || "Séquence personnalisée et comportant des filtres"',
            type: 'VTL|MD',
          },
        },
      },
    ...
    },
    {
      ...
      page: '4',
      label: {
        value: '"➡ 2. " || "Quelle est votre adresse email ?"',
        type: 'VTL|MD',
      },
      components: [
        {
      ...
      declarations: [
        {
          ...
          label: {
            value:
              '"Ajouter une décla sinon le titre de sous seq n\'apparait pas"',
            type: 'VTL|MD',
          },
        },
      ],
    ...
    },
    {
      ...
      page: '4',
      label: {
        value: '"➡ 3. " || "Bonjour " || PRENOM || ", êtes vous majeur ?" ',
        type: 'VTL|MD',
      },
      declarations: [
        {
          ...
          label: {
            value:
              '"Si vous répondez oui, alors les questions 27/28 apparaîtront"',
            type: 'VTL|MD',
          },
        },
      ],
    ...
    },
    {
      ...
      page: '4',
      label: {
        value: '"➡ 4. " || PRENOM ||", quelle est votre date de naissance ?" ',
        type: 'VTL|MD',
      },
      declarations: [
        {
        ...
        },
        {
          ...
          position: 'AFTER_QUESTION_TEXT',
          label: {
            value: '"Controle sur age et fait d\'être majeur"',
            type: 'VTL|MD',
          },
        },
        {
          ...
          controls: [
            {
              ...
              errorMessage: {
                value:
                  '"La date saisie doit être comprise entre 1900 et 2020."',
                type: 'VTL|MD',
              },
            },
            {
    ...
    },
    {
      ...
      label: {
        value:
          '"➡ 6. " || "Question masquée par défaut, qui s\'affiche lorsque l\'individu coche majeur"',
        type: 'VTL|MD',
      },
      declarations: [
        {
    ...
    },
    {
      ...
      label: {
        value:
          '"➡ 7. " || "Question affichée par défaut, filtrée si l\'individu est un homme"',
        type: 'VTL|MD',
      },
      components: [
        {
    ...
    },
    {
      ...
      hierarchy: {
        ...
        subSequence: {
          ...
          page: '5',
          label: {
            value: '"Description de votre ménage"',
            type: 'VTL|MD',
          },
        },
      },
    },
    {
      ...
      label: {
        value:
          '"➡ 1. " || "Combien de personnes vivent dans votre logement, y compris vous ?"',
        type: 'VTL|MD',
      },
      components: [
        {
    ...
    },
    {
      ...
      componentType: 'Sequence',
      page: '6',
      label: { value: '"Temps de réponse"', type: 'VTL|MD' },
      conditionFilter: { value: 'true', type: 'VTL' },
      hierarchy: {
        sequence: {
          id: 'TIME-SEQ',
    ...
    {
      id: 'question-TIME-QUESTION-HEURE-REMPL',
      componentType: 'Question',
      page: '6',
      label: {
        value:
          '"➡ 1. " || "Combien de temps avez-vous mis en tout pour répondre à cette enquête (recherche des données + remplissage du questionnaire) ?"',
        type: 'VTL|MD',
      },
      components: [
        {
          ...
          controls: [
            {
              id: 'TIME-QUESTION-HEURE-REMPL-format-borne-inf-sup',
              typeOfControl: 'FORMAT',
              criticality: 'ERROR',
              control: {
            ...
            {
              id: 'TIME-QUESTION-HEURE-REMPL-format-decimal',
              typeOfControl: 'FORMAT',
              criticality: 'ERROR',
              control: {
                value:
                  'not(not(isnull(HEURE_REMPL))  and round(HEURE_REMPL,0)<>HEURE_REMPL)',
                type: 'VTL',
              },
              errorMessage: {
                value:
    ...
    {
      id: 'question-TIME-QUESTION-MIN-REMPL',
      componentType: 'Question',
      page: '6',
      label: { value: '', type: 'VTL|MD' },
      components: [
        {
          ...
          controls: [
            {
              id: 'TIME-QUESTION-MIN-REMPL-format-borne-inf-sup',
              typeOfControl: 'FORMAT',
              criticality: 'ERROR',
              control: {
                value:
                  'not(not(isnull(MIN_REMPL)) and (0>MIN_REMPL or 59<MIN_REMPL))',
                type: 'VTL',
              },
              errorMessage: {
                value: '" La valeur doit être comprise entre 0 et 59."',
                type: 'VTL|MD',
              },
            },
            {
              id: 'TIME-QUESTION-MIN-REMPL-format-decimal',
              typeOfControl: 'FORMAT',
              criticality: 'ERROR',
              control: {
                value:
                  'not(not(isnull(MIN_REMPL))  and round(MIN_REMPL,0)<>MIN_REMPL)',
                type: 'VTL',
              },
              errorMessage: {
                value:
  ...
  variables: [
    ...
    },
    {
      ...
      variableType: 'CALCULATED',
      expression: {
        value: 'nvl(NBPERS,0) - nvl($NBENFANT$,0)',
        type: 'VTL',
      },
    ...
    {
      name: 'FILTER_RESULT_MIN_REMPL',
      variableType: 'CALCULATED',
      expression: { value: 'true', type: 'VTL' },
    },
    {
      name: 'FILTER_RESULT_COMMENT_QE',
      variableType: 'CALCULATED',
      expression: { value: 'true', type: 'VTL' },
    },
  ],
