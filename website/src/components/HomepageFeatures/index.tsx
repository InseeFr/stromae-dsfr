...
const FeatureList: FeatureItem[] = [
  {
    ...
    SvgLight: require('@site/static/img/pictograms/light/city-hall.svg')
      .default,
    SvgDark: require('@site/static/img/pictograms/dark/city-hall.svg').default,
    description: (
      <>
        Les aspects abordés sont applicables à tout produit numérique. Mais nous
        les raccrochons au contexte d'une structure publique peu importe sa
        taille.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        L'étendue des thématiques est large, et des connexions entre les
        différents chapitres sont faites pour penser la réalisation du produit
        dans son ensemble.
      </>
    ),
  },
  {
    ...
    description: (
      <>
        Tel un sillon agricole, ce "guide" est une voie préparatoire parmi tant
        d'autres pour vos projets numériques ! Vous êtes libre de faire une
